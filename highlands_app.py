...
async def load_menu_index():
    ...
    # create_all không ALTER bảng đã tồn tại, nên chạy lại lần nữa để cột
    # embedding chắc chắn có mặt trên DB đang chạy sẵn.
    ensure_vector_schema(engine)
...
app.include_router(admin_promotions_router.router)
